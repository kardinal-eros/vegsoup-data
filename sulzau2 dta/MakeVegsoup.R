...
path <- "~/Documents/vegsoup-data/sulzau2 dta"
key <- read.bib(file.path(path, "references.bib"), encoding = "UTF-8")$key

#	cd '/Users/roli/Dropbox/ENNACON/projekte/sulzau2/dta/relevees'
...
#	order layer
layers(obj)	 <- rev(c("hl", "sl", "tl1", "tl2"))

#	total canopy value
obj$canopy <- apply(sites(obj)[ , match(c("scov", "t1cov", "t2cov"), names(obj)) ], 1,
	function (x) {
